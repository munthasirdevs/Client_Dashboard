  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col gap-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white font-display">Notification Preferences</h1>
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between group">
                <div className="space-y-1">
                  <p className="text-sm font-semibold text-white group-hover:text-[#6366F1] transition-colors">{item.title}</p>
                  <p className="text-xs text-slate-500">{item.desc}</p>
                </div>
                <div className={`w-12 h-6 rounded-full relative cursor-pointer transition-colors ${item.active ? 'bg-[#6366F1]' : 'bg-slate-700'}`}>
        ...
        <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-4 rounded-xl bg-[#0B0F19] border border-white/5">
                <div className="flex items-center gap-3">
                  <div className={`w-2 h-2 rounded-full ${channel.active ? 'bg-[#6366F1]' : 'bg-slate-600'}`} />
                  <span className="text-sm font-medium text-[#c7c4d7]">{channel.name}</span>
                </div>
                <div className={`w-10 h-5 rounded-full relative cursor-pointer transition-colors ${channel.active ? 'bg-[#6366F1]' : 'bg-slate-700'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-[#0B0F19] border border-white/5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-[#0B0F19] border border-white/5">
                <Sun size={20} className="text-[#6366F1]" />
      ...
      <div className="flex justify-end gap-4 pt-8">
        <button className="px-8 py-3 rounded-xl text-[#c7c4d7] hover:text-white font-bold text-sm tracking-wide transition-all">
          Discard Changes
        </button>
        <button className="bg-[#6366F1] hover:bg-[#6366F1]/90 text-white px-8 py-3 rounded-xl font-bold text-sm tracking-wide transition-all shadow-lg shadow-[#6366F1]/20">
          Save Preferences
        </button>
      </div>
    </div>
