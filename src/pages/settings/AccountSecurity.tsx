  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col gap-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white font-display">Security Hub</h1>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                type="password" 
                placeholder="••••••••••••"
                className="w-full bg-[#0B0F19] border border-white/5 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#6366F1]/50 focus:ring-1 focus:ring-[#6366F1]/20 transition-all font-mono"
              />
            </div>
            ...
            <button className="bg-[#6366F1] hover:bg-[#6366F1]/90 text-white px-8 py-3 rounded-xl font-bold text-sm tracking-wide transition-all shadow-lg shadow-[#6366F1]/20 hover:scale-[1.02] active:scale-[0.98]">
              Update Password
            </button>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-xl bg-[#0B0F19] border border-white/5">
                <div className="flex items-center gap-3">
                  <Smartphone size={20} className="text-slate-400" />
                  <div>
                    <p className="text-sm font-medium text-white">Authenticator App</p>
                    <p className="text-[10px] text-[#6366F1] font-bold uppercase tracking-wider">Recommended</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-[#0B0F19] border border-white/5 opacity-60">
                <div className="flex items-center gap-3">
          ...
          <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 p-4 rounded-xl bg-[#0B0F19] border border-white/5 hover:border-[#6366F1]/50 transition-all">
      ...
      <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button className="text-xs font-bold text-[#6366F1] hover:text-[#6366F1]/80 uppercase tracking-widest">Sign out of all sessions</button>
        </div>

        <div className="space-y-4">
          <div className="flex items-center justify-between p-6 rounded-2xl bg-[#0B0F19] border border-white/5 group hover:border-[#6366F1]/30 transition-all">
            <div className="flex items-center gap-6">
              <div className="p-4 rounded-xl bg-[#1F2937] text-[#6366F1]">
                <Monitor size={24} />
              </div>
              <div>
                <h4 className="text-lg font-semibold text-white">MacBook Pro 16"</h4>
                <p className="text-sm text-[#c7c4d7]">San Francisco, CA • <span className="text-[#6366F1] font-medium">Current Session</span></p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <span className="px-3 py-1 rounded-full bg-[#6366F1]/10 text-[#6366F1] text-[10px] font-bold uppercase tracking-widest">Active Now</span>
          ...
          <div className="flex items-center justify-between p-6 rounded-2xl bg-[#0B0F19] border border-white/5 group hover:border-[#6366F1]/30 transition-all">
            <div className="flex items-center gap-6">
              <div className="p-4 rounded-xl bg-[#1F2937] text-slate-400">
                <Smartphone size={24} />
              </div>
              <div>
                <h4 className="text-lg font-semibold text-white">iPhone 15 Pro</h4>
                <p className="text-sm text-[#c7c4d7]">London, UK • 2 hours ago</p>
              </div>
            </div>
            <button className="px-6 py-2 rounded-xl bg-[#1F2937] text-[#dfe2f1] text-xs font-bold uppercase tracking-widest hover:bg-[#1F2937]/80 transition-all">
              Sign Out
            </button>
          </div>
        </div>
      ...
      <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 space-y-8">
            ...
            <tbody className="divide-y divide-white/5">
              {[
                ...
                <tr key={idx} className="group hover:bg-white/5 transition-colors">
                  <td className="py-4 text-sm text-[#c7c4d7] font-mono">{log.time}</td>
                  <td className="py-4">
                    <div className="flex items-center gap-2">
                      <div className={`w-1.5 h-1.5 rounded-full ${log.color === 'indigo' ? 'bg-[#6366F1]' : log.color === 'amber' ? 'bg-amber-500' : 'bg-red-500'}`} />
                      <span className="text-sm font-medium text-white">{log.action}</span>
                    </div>
                  </td>
                  <td className="py-4">
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold tracking-widest ${
                      log.status === 'COMPLETED' ? 'bg-[#6366F1]/10 text-[#6366F1]' : 'bg-red-500/10 text-red-400'
                    }`}>
                      {log.status}
                    </span>
                  </td>
                  <td className="py-4 text-sm text-[#c7c4d7] font-mono">{log.ip}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="flex justify-center pt-4">
          <button className="text-xs font-bold text-slate-500 hover:text-[#6366F1] transition-colors flex items-center gap-2 uppercase tracking-widest">
